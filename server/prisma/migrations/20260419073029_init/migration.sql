...
CREATE TABLE "CupcakeBase" (
    ...
    CONSTRAINT "CupcakeBase_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "CupcakeFilling" (
    "id" TEXT NOT NULL,
    "name" TEXT NOT NULL,
    "description" TEXT,
    "image" TEXT,
    ...
    CONSTRAINT "CupcakeFilling_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "TopColor" (
    "id" TEXT NOT NULL,
    "name" TEXT NOT NULL,
    "description" TEXT,
    "image" TEXT,
    ...
    CONSTRAINT "TopColor_pkey" PRIMARY KEY ("id")
);
