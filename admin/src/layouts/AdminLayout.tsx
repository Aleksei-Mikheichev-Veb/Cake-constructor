...
const menuItems = [
    ...
    { key: '/cupcakes', icon: <ShoppingOutlined />, label: 'Капкейки' },
    { key: '/top-colors', icon: <BgColorsOutlined />, label: 'Кремовые шапки' },
    { key: '/prices', icon: <DollarOutlined />, label: 'Цены' },
    { key: '/feedback', icon: <StarOutlined />, label: 'Отзывы' },
    { key: '/settings', icon: <SettingOutlined />, label: 'Настройки сайта' },
];
